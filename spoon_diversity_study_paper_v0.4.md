...
### Measures
The dataset schema is defined in `spoon_diversity_dataset_template_v0.4.csv`:
...
### Reproducibility
Ontology (`spore_SpoonDiversityOntology_v0.4.ttl`) and diagrams are versioned with this repository. Analysis steps are documented in `spoon_analysis_pipeline_v0.4.mmd`. The data dictionary is provided in `spoon_diversity_data_dictionary_v0.4.md`.
